...
class StudentScreen extends JFrame {
	//
	private Student student;
	JLabel lbl[]=new JLabel[7];
	String lblNames[]= {"Student ID:","First Name","Last Name:","Address:",
	...
	public void showRow()
	{
		txt[0].setText(student.getStudentID());
		txt[1].setText(student.getFirstName());
		txt[2].setText(student.getLastName());
		
		txt[3].setText(student.getAddress());
		txt[4].setText(student.getCity());
		txt[5].setText(student.getProvince());
		txt[6].setText(student.getPostalCode());
	}
	//    
